...
int main(int argc, char** argv)
{
	...
	string serialTimer = "Serial Algorithm";
	string paralllTimer = "Parallel Algorithm";
	timer.setTimerName(0, serialTimer);
	timer.setTimerName(1, paralllTimer);
	...
	#pragma omp parallel num_threads(numThread)
	{
		...
		int end= dataSize / numThread * (omp_get_thread_num()+1);
